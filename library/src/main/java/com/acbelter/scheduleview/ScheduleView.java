    ...
    public ScheduleView(Context context, AttributeSet attrs) {
        ...
        try {
            if (a != null) {
                ...
                mInternalPaddingTop = (int) a.getDimension(R.styleable
                                .ScheduleView_internalPaddingTop,
                        TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 8, dm));
                mInternalPaddingBottom = (int) a.getDimension(R.styleable
                                .ScheduleView_internalPaddingBottom,
                        TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 8, dm));
